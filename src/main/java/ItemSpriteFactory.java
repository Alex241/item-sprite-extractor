...
public class ItemSpriteFactory {
    ...
    private static final SpritePixels createSpritePixels(ItemProvider itemProvider, ModelProvider modelProvider,
                                                         ...
                                                         boolean noted) throws IOException
    {
        return createSpritePixels(itemProvider, modelProvider, spriteProvider, textureProvider, itemId, quantity, border, shadowColor, noted,
                36, 32, 1, 0, 36D);
    }

    public static final SpritePixels createSpritePixels(ItemProvider itemProvider, ModelProvider modelProvider,
                                                        SpriteProvider spriteProvider, TextureProvider textureProvider,
                                                        int itemId, int quantity, int border, int shadowColor,
                                                        boolean noted, int width, int height, int borderThickness, int borderColour, double zoom) throws IOException {
